...
export default function IntegrationsSettingsPage() {
    const tabs = [
        ...
        { name: "Integrations", href: "/settings/integrations", active: true },
    ];
            ...
            <div className="flex-1 flex flex-col">
                <div className="flex-1 pt-14 pb-8 pr-8 pl-28 text-white max-w-4xl">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h2 className="text-base font-medium mb-1">Trello</h2>
                            <p className="text-sm text-gray-500">Connect your Trello account to import boards.</p>
                        </div>
